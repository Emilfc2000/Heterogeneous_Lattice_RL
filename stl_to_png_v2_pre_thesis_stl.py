...
input_folder = "All_pre_thesis_stl"  # Replace with the folder containing STL files
output_folder = "All_pre_thesis_png"  # Replace with the folder where to save the PNG images
